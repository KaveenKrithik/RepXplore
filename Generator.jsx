...
import { SCHEMES, WORKOUTS } from '../utils/rep'
...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"Brew Your Plan"} title={['It\'s','about', 'Time']}>
            <Header index={'Y'} title={'Choose Your Plan'} description={"Pick the workout plan."} />
            ...
            <Header index={'E'} title={'Pick Your Point'} description={"Select the part."} />
            ...
            <Header index={'S'} title={'Choose the Objective'} description={"Final step."} />
            ...
            <Button func={updateWorkout} text={"Brew"}></Button>
        </SectionWrapper>
